...
$('#searchcode').click(function () {
    ...
    for (i = 0; arrangement.length; i++) {
        if (value === arrangement[i].code) {
            $("#codeprint").append("Name  of Product :  " + arrangement[i].name + "<br>" + "Code  : " + arrangement[i].code + "<br>");
        } else
...
$('#searchname').click(function () {
    ...
    for (let i = 0; arrangement.length; i++) {
        if (valuer === arrangement[i].name) {
            $("#nameprint").append("Name  of Product :  " + arrangement[i].name + "<br>" + "Code  : " + arrangement[i].code + "<br>");
        } else
